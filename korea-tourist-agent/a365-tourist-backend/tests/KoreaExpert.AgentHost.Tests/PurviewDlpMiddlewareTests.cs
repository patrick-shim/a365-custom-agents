...
public sealed class PurviewDlpMiddlewareTests
{
    ...
    public void PurviewConversationIncludesAgentIdentityMetadata()
    {
        ...
        Assert.AreEqual("Korea Tourist Expert Test", agent.GetProperty("name").GetString());
    ...
    {
        PurviewSerializationWorkaround.Apply();
        var settings = new PurviewSettings("Korea Tourist Expert Test")
        {
            AppVersion = "1.0",
