...
namespace SeoulTourist.Mcp.Attractions;
    ...
    ILogger<AttractionTools> logger)
{
    ...
    [Description("Searches attributed Microsoft Azure Maps data for Seoul attractions near a specified point.")]
    public Task<IReadOnlyList<TourismAttraction>> SearchSeoulAttractionsAsync(
