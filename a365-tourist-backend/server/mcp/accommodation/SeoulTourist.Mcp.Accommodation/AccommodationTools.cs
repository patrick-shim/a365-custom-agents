...
namespace SeoulTourist.Mcp.Accommodation;
    ...
    ILogger<AccommodationTools> logger)
{
    ...
    [Description("Searches Microsoft Azure Maps for accommodation locations in Seoul. This returns places, not live room inventory or prices.")]
    public Task<IReadOnlyList<PlaceResult>> SearchSeoulAccommodationAsync(
