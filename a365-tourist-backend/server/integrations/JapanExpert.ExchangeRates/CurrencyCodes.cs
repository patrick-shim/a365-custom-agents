...
/// <summary>
/// ISO 4217 helpers for the Japan Expert currency contract, including the zero-decimal
...
{
    /// <summary>Default travel currency for the Japan Expert product.</summary>
