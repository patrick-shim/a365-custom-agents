...
builder.AddAgent<SeoulTouristApplication>();
...
app.MapGet("/", () => Results.Text(
    "Seoul Tourist Assistant",
    "text/plain"))
    .AllowAnonymous();
app.MapGet("/privacy", () => Results.Text(
    "The Seoul Tourist Assistant processes conversation and tool content under your organization's Microsoft 365 and Microsoft Purview policies. Contact your tenant administrator for retention, access, and deletion requests.",
    "text/plain"))
    .AllowAnonymous();
app.MapGet("/terms", () => Results.Text(
    "Use of the Seoul Tourist Assistant is subject to your organization's Microsoft 365 policies. Travel, weather, place, and exchange-rate results are informational and should be independently verified.",
    "text/plain"))
    .AllowAnonymous();
