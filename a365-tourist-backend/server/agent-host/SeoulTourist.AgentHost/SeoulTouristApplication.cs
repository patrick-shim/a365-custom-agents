...
public sealed partial class SeoulTouristApplication : AgentApplication
{
    ...
    private readonly ILogger<SeoulTouristApplication> _logger;
    private readonly bool _isLocalEnvironment;

    public SeoulTouristApplication(
        ...
        ILogger<SeoulTouristApplication> logger)
        : base(options)
    {
        ...
        foreach (var member in turnContext.Activity.MembersAdded ?? [])
        {
            if (member.Id != turnContext.Activity.Recipient?.Id)
            {
                await turnContext.SendActivityAsync(
                    MessageFactory.Text("Hello. I can help plan a Seoul visit around your schedule, weather, and preferences."),
                    cancellationToken);
            }
        }
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            await turnContext.SendActivityAsync(
                MessageFactory.Text("Tell me what you would like to plan in Seoul."),
                cancellationToken);
            return;
        }
        ...
        Guid? authenticatedUserId)
    {
        ...
        var agentDetails = new AgentDetails(
            agentId: turnTokens.AgentId,
            agentName: "Seoul Tourist Assistant",
            agentDescription: "Governed Seoul travel planning assistant",
