...
public sealed class InternalMcpToolCatalogTests
{
    ...
    public sealed class AttractionsTool
    {
        ...
        [System.ComponentModel.Description("Searches attributed Microsoft Azure Maps data for Korea attractions near a specified point.")]
    ...
    public sealed class WeatherTool
    {
        ...
        [System.ComponentModel.Description("Gets attributed current weather for a location in Korea.")]
        public static string Current(
            [System.ComponentModel.Description("Latitude inside Korea. Defaults to central Seoul.")] double latitude = 37.5665,
            [System.ComponentModel.Description("Longitude inside Korea. Defaults to central Seoul.")] double longitude = 126.9780) => "ok";

        [McpServerTool(Name = "get_korea_weather_forecast")]
        [System.ComponentModel.Description("Gets an attributed daily weather forecast for itinerary planning in Korea.")]
        public static string Forecast(
            [System.ComponentModel.Description("Latitude inside Korea. Defaults to central Seoul.")] double latitude = 37.5665,
            [System.ComponentModel.Description("Longitude inside Korea. Defaults to central Seoul.")] double longitude = 126.9780,
        ...
        [System.ComponentModel.Description("Gets current government weather alerts for a location in Korea when the optional alert provider is configured.")]
    ...
    public sealed class AccommodationTool
    {
        ...
        [System.ComponentModel.Description("Searches Microsoft Azure Maps for accommodation locations in Korea. This returns places, not live room inventory or prices.")]
        public static string Invoke(
