...
function Test-StaRepositoryConfiguration {
    ...
    $readmeValid = $readmeFirstLine -eq '# Korea Expert Assistant Backend'
    $results.Add((New-StaValidationResult -Area 'Repository' -Check 'README identity' `
        ...
        -Remediation $(if ($readmeValid) { '' } else { 'Replace README.md with the Korea Expert Assistant Backend documentation.' })))
    ...
    if ($ProbePolicy) {
        ...
        if ([string]::IsNullOrWhiteSpace($token) -or [string]::IsNullOrWhiteSpace($UserId) -or [string]::IsNullOrWhiteSpace($ApplicationId)) {
            ...
            $entry = [ordered]@{
                ...
                name            = 'Korea Expert validation probe'
            ...
            $requestBody = [ordered]@{
                contentToProcess = [ordered]@{
                    ...
                    integratedAppMetadata = [ordered]@{
                        name = 'Korea Expert Assistant validation tools'
                        version = '1.0'
                    }
                }
            }
