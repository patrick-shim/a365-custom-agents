...
resource mcpApiApplication 'Microsoft.Graph/applications@v1.0' = {
  ...
  description: 'Single-tenant API for authenticated Japan Tourist Expert MCP workloads.'
  ...
  api: {
    ...
    oauth2PermissionScopes: [
      {
        adminConsentDescription: 'Allow this Agent 365 identity to invoke protected Japan Tourist Expert MCP tools.'
        adminConsentDisplayName: 'Invoke Japan Tourist Expert MCP tools'
        id: mcpInvokeScopeId
        isEnabled: true
        type: 'Admin'
        userConsentDescription: 'Allow this Agent 365 identity to invoke protected Japan Tourist Expert MCP tools.'
        userConsentDisplayName: 'Invoke Japan Tourist Expert MCP tools'
        value: 'Mcp.Invoke'
      }
    ]
  }
