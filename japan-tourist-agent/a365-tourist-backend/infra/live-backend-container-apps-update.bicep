// Japan Tourist Expert existing-backend update and rollback wrapper.
//
// Scope contract (M8):
...
@description('Deterministic Japan Tourist Expert resource token. Lowercase alphanumeric only.')
@minLength(3)
@maxLength(16)
