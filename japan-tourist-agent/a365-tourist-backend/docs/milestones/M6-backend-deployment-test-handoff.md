...
> Historical M6 handoff. The M5 rollout described here completed on 2026-08-16, and M7 subsequently
> owned Seoul cross-channel alignment. Active M8 now owns fresh Japan Expert deployment and tenant
> operations under its reviewed dry-run, rollback, and explicit-approval gates; this handoff remains
> evidence only.
