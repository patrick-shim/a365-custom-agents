...
public sealed class JapanExpertBrandingTests
{
    ...
    public void PurviewApplicationNameDefaultsToJapanExpert()
    {
        ...
        Assert.AreEqual("Japan Tourist Expert", options.AppName);
    }
    ...
    public void LandingEndpointsUseJapanExpertBranding()
    {
        ...
        StringAssert.Contains(program, "\"Japan Tourist Expert\"");
        StringAssert.Contains(program, "Japan Tourist Expert processes conversation and tool content");
        StringAssert.Contains(program, "Use of Japan Tourist Expert is subject to your organization's Microsoft 365 policies");
    }
    ...
    public void ConversationGuidanceTargetsJapanRatherThanASingleCity()
    {
        ...
        StringAssert.Contains(application, "agentName: \"Japan Tourist Expert\"");
