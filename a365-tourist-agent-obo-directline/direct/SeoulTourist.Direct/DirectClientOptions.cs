...
public sealed class DirectClientOptions
{
    public const string DefaultSecretEnvironmentVariable =
        "SEOUL_TOURIST_DIRECT_LINE_SECRET";

    public const string EndpointEnvironmentVariable =
        "SEOUL_TOURIST_DIRECT_LINE_ENDPOINT";
        ...
        Func<string, string?>? readEnvironmentVariable = null)
    {
        ...
        var userId = "dl_seoul_tourist_cli";
        var userName = "Seoul Tourist CLI";
    ...
    public static string GetHelpText() =>
        $$"""
        Seoul Tourist Direct Line client

        Usage:
          dotnet run --project direct/SeoulTourist.Direct -- [options]
        ...
        Options:
          ...
          --user-id <id>            Stable Direct Line user ID (default: dl_seoul_tourist_cli).
